...
export interface AgentsAbilitiesVideos {
  name: AgentName;
  videos: string[];
}
...
export default [
  {
    name: 'fade',
    videos: [
      'https://assets.contentstack.io/v3/assets/bltb6530b271fddd0b1/bltbec73caca7bf1045/625f2c0cfd9afd4b1fe300e6/Q-Seize_video.mp4',
